...
public interface HowToSection extends CreativeWork, ItemList, ListItem {
    public interface Builder extends CreativeWork.Builder, ItemList.Builder, ListItem.Builder {
        ...
        @Override
        HowToStep.Builder addProperty(String name, SchemaOrgType value);

        @Override
        HowToStep.Builder addProperty(String name, Thing.Builder builder);

        @Override
        HowToStep.Builder addProperty(String name, String value);
